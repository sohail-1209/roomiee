  ...
  return (
    <div className="min-h-screen bg-surface-50">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-10 left-[10%] w-72 h-72 bg-white/10 rounded-full blur-3xl animate-liquid-float" />
        <div className="absolute bottom-10 right-[15%] w-64 h-64 bg-accent-300/20 rounded-full blur-3xl animate-liquid-float" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary-300/15 rounded-full blur-[100px] animate-liquid-float" style={{ animationDelay: '4s' }} />
        <div className="absolute -top-20 -right-20 w-80 h-80 bg-white/5 animate-morph" />

        <div className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-12 pb-14 transition-all duration-700 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full glass text-white text-xs font-medium mb-4">
              <Sparkles size={12} />
              India&#39;s Fastest Growing Room Finder
            </div>
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl tracking-tight text-white mb-3">
              Find your next<br />
          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
            <div className="glass-strong rounded-3xl p-3">
              <div className="flex gap-2">
                ...
                <button type="submit" className="btn-primary px-7 py-3.5 rounded-2xl text-sm font-semibold shrink-0 ripple-container shadow-lg">
                  <Search size={16} />
                  Search
                </button>
              </div>
          ...
          <div className="grid grid-cols-3 gap-4 stagger-children">
            {[
              ...
              <div key={label} className="flex items-center gap-3 justify-center sm:justify-start">
                <div className="w-11 h-11 rounded-2xl bg-white/60 flex items-center justify-center shrink-0 shadow-sm">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-10">
        <div className="glass-dark rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-white">
          ...
          <Link to="/register" className="btn bg-white/90 text-surface-900 hover:bg-white px-6 py-2.5 rounded-2xl text-sm font-semibold shrink-0 ripple-container shadow-lg">
            Post Free Listing
          </Link>
        </div>
      </section>
